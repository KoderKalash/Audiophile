...
const cartSlice = createSlice({
  name: "cart",
  initialState,
  //   these are actions that can be executed to change the state of the cart: add to cart, remove from cart,increment cart items, decrement cart item, clear cart.
  reducers: {
